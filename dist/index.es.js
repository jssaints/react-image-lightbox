      ...
      var addImage = function addImage(srcType, imageClass, transforms) {
        ...
        if (bestImageInfo.content) {
          ...
          images.push(React.createElement("div", {
            ...
            style: imageStyle,
            className: "".concat(imageClass, " ril__image")
          }, React.createElement(FileIcon, _extends({
            size: 60,
            extension: Extension
          ...
          images.push(React.createElement("div", {
            ...
            style: imageStyle,
            key: _this16.props[srcType] + keyEndings[srcType]
          }, React.createElement("p", null, "Alternative text - include a link ", React.createElement("a", {
            href: imageSrc
          }, "to the PDF!")))));
        } else {
          if (discourageDownloads) {
            ...
            images.push(isVideo(imageSrc) ? React.createElement("div", {
              key: imageSrc + keyEndings[srcType],
              style: imageStyle,
              className: "".concat(imageClass, " ril__image")
            }, imageClass === "ril-image-current" && React.createElement(Player, {
              ...
              src: imageSrc,
              type: "video/mp4"
            }))) : React.createElement("div", null, isAudio(imageSrc) ? React.createElement("div", null, React.createElement("audio", {
              style: imageStyle,
              className: "".concat(imageClass, " ril__image"),
              key: imageSrc + keyEndings[srcType],
              src: imageSrc,
              ...
              controls: true
            })) : React.createElement("img", _extends({}, imageCrossOrigin ? {
